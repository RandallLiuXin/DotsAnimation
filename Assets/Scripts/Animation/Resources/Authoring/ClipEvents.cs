...
namespace Tinder.Animation.Authoring
{
    ...
    {
        /// <summary>
        /// Generates an array of ClipEvent which can be used for generating Animation animation clip blobs.
        /// For each AnimationEvent in the clip, functionName, intParameter, and time are extracted.
        /// </summary>
        public static ClipEvent[] ExtractAnimationClipEvents(this AnimationClip clip)
        {
