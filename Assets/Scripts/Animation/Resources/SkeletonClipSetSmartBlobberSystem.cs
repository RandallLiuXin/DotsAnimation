...
namespace Tinder.Animation.Authoring
{
    ...
    public struct SkeletonClipConfig
    {
        ...
        /// An array can be auto-generated by calling AnimationClip.ExtractAnimationClipEvents().
        /// </summary>
    ...
    public class SkeletonClipSetSmartBlobberSystem : SmartBlobberConversionSystem<SkeletonClipSetBlob, SkeletonClipSetBakeData, SkeletonClipSetConverter>
    {
        ...
        protected override bool Filter(in SkeletonClipSetBakeData input, GameObject gameObject, out SkeletonClipSetConverter converter)
        {
            ...
            foreach (var clip in input.clips)
            {
                if (clip.clip == null)
                {
                    Debug.LogError($"Animation failed to convert clip set on animator {input.animator.gameObject.name} due to one fo the clips being null.");
                    return false;
                }
            ...
            {
                Debug.LogError($"Animation failed to convert clip set on animator {input.animator.gameObject.name} because the passed-in animator is not marked for conversion.");
                return false;
            }
