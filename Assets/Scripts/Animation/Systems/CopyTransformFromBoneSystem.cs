        ...
        protected override void OnCreate()
        {
            m_query = GetEntityQuery(new EntityQueryDesc
            {
                All = new[] {
                    ...
                    ComponentType.ReadOnly<CopyLocalToParentFromBone>(),
                    ComponentType.ReadOnly<BoneOwningSkeletonReference>()
                },
            });
        }
